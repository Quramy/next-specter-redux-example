declare module 'redux-effects-steps' {
  ...
  type Action<P> = {
    type: string
    payload?: P
    meta?: Record<string | symbol | number, any> | null
    error?: boolean
  }
  ...
  export declare function steps<R = any>(...args: [AnyAction | Array<Promise<any> | PromisableFunction>, ...Array<StepItem>]): StepAction
